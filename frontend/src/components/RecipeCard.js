...
const FOOD_IMAGES = [
  ...
  "https://images.unsplash.com/photo-1551183053-bf91798d047f?w=400&q=80",
  ...
  "https://images.unsplash.com/photo-1560684352-8497838a2229?w=400&q=80",
...
function getImageForRecipe(recipe) {
  ...
  if (name.includes("lamb"))      return "https://images.unsplash.com/photo-1603360946369-dc9bb6258143?w=400&q=80";
  if (name.includes("salmon"))    return "https://images.unsplash.com/photo-1467003909585-2f8a72700288?w=400&q=80";
  if (name.includes("shrimp"))    return "https://images.unsplash.com/photo-1565680018093-ebb6b9ab5460?w=400&q=80";
  if (name.includes("ice cream")) return "https://images.unsplash.com/photo-1497034825429-c343d7c6a68f?w=400&q=80";
  if (name.includes("pie"))       return "https://images.unsplash.com/photo-1535920527002-b35e96722eb9?w=400&q=80";
  if (name.includes("brownie"))   return "https://images.unsplash.com/photo-1606313564200-e75d5e30476c?w=400&q=80";
  if (name.includes("smoothie"))  return "https://images.unsplash.com/photo-1505252585461-04db1eb84625?w=400&q=80";
  if (name.includes("wrap"))      return "https://images.unsplash.com/photo-1626700051175-6818013e1d4f?w=400&q=80";
  if (name.includes("stew"))      return "https://images.unsplash.com/photo-1604909052743-94e838986d24?w=400&q=80";
  if (name.includes("roast"))     return "https://images.unsplash.com/photo-1544025162-d76694265947?w=400&q=80";
  if (name.includes("grilled"))   return "https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=400&q=80";
  if (name.includes("fried"))     return "https://images.unsplash.com/photo-1573080496219-bb080dd4f877?w=400&q=80";
  if (name.includes("baked"))     return "https://images.unsplash.com/photo-1509440159596-0249088772ff?w=400&q=80";
  if (name.includes("cream"))     return "https://images.unsplash.com/photo-1488477181946-6428a0291777?w=400&q=80";
  if (name.includes("garlic"))    return "https://images.unsplash.com/photo-1540148426945-6cf22a6b2383?w=400&q=80";
  if (name.includes("corn"))      return "https://images.unsplash.com/photo-1551754655-cd27e38d2076?w=400&q=80";
  if (name.includes("bean"))      return "https://images.unsplash.com/photo-1515543904379-3d757fab96f0?w=400&q=80";
  if (name.includes("spinach"))   return "https://images.unsplash.com/photo-1576045057995-568f588f82fb?w=400&q=80";
  if (name.includes("carrot"))    return "https://images.unsplash.com/photo-1598170845058-32b9d6a5da37?w=400&q=80";
  if (name.includes("mango"))     return "https://images.unsplash.com/photo-1601493700631-2b16ec4b4716?w=400&q=80";
  if (name.includes("coconut"))   return "https://images.unsplash.com/photo-1580984969071-a8da8d0f9e6d?w=400&q=80";
    ...
    <div style={styles.card}>
      <div style={styles.imgWrapper}>
        ...
        {recipe.score !== undefined && (
          <div style={styles.scoreBadge}>{recipe.score}</div>
        )}
      </div>
          ...
          <div style={styles.nutritionRow}>
            {recipe.nutrition.slice(0, 4).map((val, i) => (
              <span key={i} style={styles.nutBadge}>
                {NUTRIENTS[i]}: {typeof val === "number" ? val.toFixed(1) : val}
              </span>
            ))}
          </div>
        )}
...
const styles = {
  card: {
    ...
    boxShadow: "0 0 16px rgba(0,255,247,0.15)",
    marginBottom: 16,
  ...
  scoreBadge: {
    ...
    background: "rgba(0,0,0,0.8)", color: "#00fff7",
  ...
  meta: { color: "#00fff7", fontSize: "0.8rem", margin: "0 0 8px" },
  nutritionRow: { display: "flex", flexWrap: "wrap", gap: 4, margin: "0 0 8px" },
  nutBadge: {
    background: "rgba(0,255,247,0.1)",
    padding: "2px 8px", borderRadius: 10,
    fontSize: "0.72rem", color: "#00fff7",
    border: "1px solid rgba(0,255,247,0.3)",
  },
  ings: { color: "#aaa", fontSize: "0.8rem", margin: "0 0 10px" },
  saveBtn: {
